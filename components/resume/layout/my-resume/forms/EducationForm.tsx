                        ...
                        <FormControl>
                          {config.type === "textarea" ? (
                            <Textarea
                              ...
                              className={`no-focus ${form.formState.errors.education?.[index]?.[
                                  config.name
                                ]
                                  ? "error"
                                  : ""
        ...
        <div className="my-5" ref={listRef}>
          ...
          {aiGeneratedDescriptionList?.map((item: any, index: number) => (
            <div
              ...
              className={`my-4 rounded-lg border border-border bg-background p-5 ${isAiLoading ? "cursor-not-allowed" : "cursor-pointer"
                }`}
